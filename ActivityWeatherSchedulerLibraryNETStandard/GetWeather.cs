...
namespace ActivityWeatherSchedulerLibraryNETStandard
{
    public static class GetWeather
    {
        ...
        public static IEnumerable<WeatherForecast> GetWeatherForecastsForGeolocation(double latitude, double longitude)
        {
            var weather = GetWeatherForGeolocation(latitude, longitude);
            return GetWeatherForecasts(weather);
        }

        public static IEnumerable<WeatherForecast> GetWeatherForecastsForZip(string zip)
        {
            var weather = GetWeatherForZip(zip);
            return GetWeatherForecasts(weather);
        }
